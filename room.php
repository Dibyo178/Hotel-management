                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                        <ul class="nav navbar-nav menu_nav ml-auto">
                            ...
                            <li class="nav-item active"><a class="nav-link" href="room.php">Type Rooms</a></li>
                ...
                <div class="row mb_30 justify-content-center">
                    <div class="col-lg-3 col-sm-6">
                        <div class="accomodation_item text-center">
                            ...
                            <a href="#"><h4 class="sec_h4 header-text" style="font-size: 24px;">AC Room</h4></a>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="accomodation_item text-center">
                            ...
                            <a href="#"><h4 class="sec_h4 header-text" style="font-size: 24px;">Non AC Room</h4></a>
                            <h5>2000<small>.-/ BDT</small></h5>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-6">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="accomodation_item text-center">
                            ...
                            <a href="#"><h4 class="sec_h4 header-text" style="font-size: 24px;">Family Room</h4></a>
                            <h5>2000<small>.-/ BDT</small></h5>
                        </div>
                    </div>
                </div>
